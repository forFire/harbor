...
@Component
@Scope("singleton")
public class RequestStatusEncoderServiceImpl implements BeidouEncoderService {

    private InstructType type      = InstructType.RequestStatus;

    private final BeidouEncoderType SENT_TYPE = BeidouEncoderType.request_status;

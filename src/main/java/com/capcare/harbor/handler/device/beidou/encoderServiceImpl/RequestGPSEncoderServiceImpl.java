...
@Component
@Scope("singleton")
public class RequestGPSEncoderServiceImpl implements BeidouEncoderService {

    private InstructType type      = InstructType.RequestGPS;

    private final BeidouEncoderType SENT_TYPE = BeidouEncoderType.request_GPS;
